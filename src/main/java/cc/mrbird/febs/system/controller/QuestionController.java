...
/**
 * @author Modified by XiaoMingliang
 */
@Slf4j
@Validated
@RestController
...
//    }
    ...
    /**
     * 第五步
     * 修改下面获取数据的方法，在这个方法中调用
     * questionService中的 findQuestionDetailList 方法。
     *
     * 第六步， 修改 question.html中的 javascript 的方法，
     * 在inittable方法中，修改在页面中显示的
     * 数据的列，使其各列与预期查询出来的结果一致。
     *
     */
    @GetMapping("list")
    //@RequiresPermissions("user:view")
    public FebsResponse questionList(Question question, QueryRequest request) {
        Map<String, Object> dataTable = getDataTable(this.questionService.findQuestionDetailList(question, request));
...
//    public FebsResponse addQuestion(@Valid Question question) {
