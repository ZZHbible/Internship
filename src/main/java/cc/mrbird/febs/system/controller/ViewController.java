...
public class ViewController extends BaseController {
    ...
    /**
     * The code below is add by me
     * Add function of question management
     * 第一步： 在页面中菜单管理添加 新菜单
     * 并定义URL地址
     * 然后添加下面的方法，加入GetMapping
     * 在参数中，填写之前定义的URL
     * 在下面的方法中，需要返回对应的html页面
     * 此页面为仿造user.html 页面而成。
     * 所以，需要resources中，对应的目录下，
     * 建立question文件夹，将 user 文件夹中的内容，
     * 全部copy至question，然后修改文件的名称。
     *
     * 第二步，需要在数据库中建立对应的table
     * 进入到entity文件夹，建立与table对应的类。
     *
     */
    @GetMapping(FebsConstant.VIEW_PREFIX + "system/question")
    public String systemQuestion() {
        return FebsUtil.view("system/question/question");
    }

    @GetMapping(FebsConstant.VIEW_PREFIX+"system/questionAdd")
    public String systemQuestionAdd() {
        return FebsUtil.view("system/question/questionAdd");
    }

    @GetMapping(FebsConstant.VIEW_PREFIX + "system/option")
    public String systemOption() {
        return FebsUtil.view("system/option/option");
    }
